...
const chartData = [
  ...
  { name: '15 Авг', score: 70 }, { name: '17 Авг', score: 75 }, { name: '18 Авг', score: 82 },
  { name: '19 Авг', score: 78 },
];
...
function App() {
  ...
  const initialTestsData = [
    ...
    { 
      id: 1, title: "Квадрат теңдеулер", classLabel: "8 сынып", topic: "Алгебра", questionsCount: 15, takes: 27, avgScore: "82%", status: "Белсенді", date: "19.08.2026",
      questions: mockQuadEq
    },
    { 
      id: 2, title: "Сызықтық функциялар", classLabel: "7 сынып", topic: "Алгебра", questionsCount: 2, takes: 31, avgScore: "76%", status: "Белсенді", date: "19.08.2026", 
      questions: [
    ...
    { 
      id: 3, title: "Пайыз", classLabel: "6 сынып", topic: "Алгебра", questionsCount: 2, takes: 24, avgScore: "89%", status: "Аяқталды", date: "19.08.2026", 
      questions: [
    ...
    { 
      id: 4, title: "Пифагор теоремасы", classLabel: "8 сынып", topic: "Геометрия", questionsCount: 2, takes: 0, avgScore: "-", status: "Қаралама", date: "19.08.2026", 
      questions: [
